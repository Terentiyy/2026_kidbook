# [Внешняя память](../../../4.2_thinking_and_working_information/how_to_search_information/articles/second_mind.md): [интернет](../../../1.2_natural_sciences/physics_in_everyday_life/Q26540.md) как жесткий [диск](../../operating system/articles/file_system.md) нашего мозга
...
**Как изменились [стратегии](../../../../8.1_self_understanding/articles/overcoming.md) запоминания:**

| Раньше | Сейчас |
|:-------|:-------|
| Заучивали стихи наизусть | Ищем [текст](../../../4.1_rules_of_study/how_to_learn_effectively/articles/reading_skills.md) по первой строчке |
...
| [Помнить](../../../4.1_rules_of_study/how_to_memorize/articles/pamyat.md) дорогу домой | Вбиваем [адрес](../../how_internet_works/articles/ip_mac/ip_and_mac.md) в навигатор |
...
|:------------|:-----------|
| Папа | Как менять колесо, где лежат [инструменты](../../../1.2_natural_sciences/physics_in_everyday_life/Q36253.md), как настроить [Wi-Fi](../../how_internet_works/articles/history/internet_at_home.md) |
| Мама | Дни рождения всех родственников, рецепты, где что лежит в квартире |
| [Ребенок](../../information and media literacy/информационная_безопасность_для_детей.md) | Как проходить [компьютерные игры](../../../3.1_healthy lifestyle/vrednye_privychki/articles/computer_games.md), где скачать [фильмы](../../../7.2 Media, leisure and hobbies /what_you_can_read_and_watch_to_develop_your_taste/articles/z1.md), пароли от соцсетей |

Никто не помнит всё. Но все знают, *у кого что спросить*. Это и есть транзактивная память.

В XXI веке главным участником этой системы стал интернет. Теперь мы спрашиваем не только у людей, но и у поисковиков. Более того, [поисковик](../../information and media literacy/роль_поисковых_систем.md) часто оказывается умнее любого эксперта, потому что в нем собраны знания миллионов людей.

## Как мы запоминаем сегодня: новый [алгоритм](../../../2.1_society/cause_and_effect_relationships/articles/ai_causality.md)

[Процесс](../../operating system/articles/process.md) [работы](../../../8.2_future/choosing_a_career_path/articles/interview.md) с информацией в современном мире выглядит так:

1. **Встреча с новой информацией.** Мы читаем пост, смотрим [видео](../../information and media literacy/оценка_качества_изображений_и_видео.md), слышим [новость](../../information and media literacy/информационная_диета.md).
2. **[Оценка](../../../4.1_rules_of_study/how_to_learn_effectively/articles/self_reflection.md) важности.** Нужно ли это для жизни или просто развлечение?
3. **Если важно:**
   * Раньше: пытались запомнить.
   * Сейчас: сохраняем ссылку, делаем скриншот, добавляем в [закладки](../../../4.2_thinking_and_working_information/how_to_search_information/articles/second_mind.md), записываем ключевые слова для поиска.
4. **При необходимости использования:** ищем по сохраненному пути.

Мы запоминаем не ответы, а **пути доступа к ответам**. Мозг превратился из [базы данных](../../../7.1_art/modern_technological_art/articles/2.2_heath_bunting.md) в навигационную систему.

## Плюсы [внешней памяти](../../../4.2_thinking_and_working_information/how_to_search_information/articles/second_mind.md)
...
В 2008 году исследователи из Колумбийского университета обнаружили, что люди лучше помнят, где найти информацию, чем саму информацию. Это [явление](../../../1.2_natural_sciences/physics_in_everyday_life/Q163214.md) назвали "эффектом Google".
