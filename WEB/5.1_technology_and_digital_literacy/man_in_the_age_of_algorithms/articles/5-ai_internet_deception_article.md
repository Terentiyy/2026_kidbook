...
Проблема заключается в [том](../../../7.1_art/musical_instruments/articles/drums.md), что подобный [контент](../../information and media literacy/информационная_диета.md) может использоваться
...
Кроме текстов, [нейросети](../../../2.1_society/cause_and_effect_relationships/articles/ai_causality.md) умеют генерировать изображения и иллюстрации.
...
## [Deepfake](../../../4.2_thinking_and_working_information/how_to_search_information/articles/deepfake.md)‑[технологии](../../../2.2_history/world_economy_on_fingers/articles/globalizatsiya.md)

Одной из наиболее обсуждаемых технологий стали так называемые
**[deepfake](../../../4.2_thinking_and_working_information/how_to_search_information/articles/deepfake.md)**. Это [методы](../../../4.1_rules_of_study/how_to_learn_effectively/articles/note_taking.md) создания [видео](../../information and media literacy/оценка_качества_изображений_и_видео.md) и аудио, в которых лицо или
голос человека искусственно изменяются с помощью нейросетей.

![](../images/deepfake.webp)

Такие технологии позволяют создавать ролики, где [человек](../../../1.2_natural_sciences/physics_in_everyday_life/Q45003.md) якобы говорит
...
## [Масштаб](../../../1.2_natural_sciences/math_in_life/articles/06_scale.md) проблемы
...
Это приводит к тому, что [интернет](../../../1.2_natural_sciences/physics_in_everyday_life/Q26540.md) наполняется огромным количеством
...
-   обращать [внимание](../../../1.2_natural_sciences/neurobiology_for_teens/articles/16_love_chemistry.md) на автора и [источник](../../information and media literacy/дезинформация_и_фейки.md) публикации;
...
информацию и критически оценивать [источники](../../../4.2_thinking_and_working_information/how_to_search_information/articles/three_whales.md) становится одним из ключевых
...
- [Трансформация мышления: как интернет меняет наши когнитивные способности](4-internet_thinking_transformation.md) — [критическое мышление](../../../1.2_natural_sciences/neurobiology_for_teens/articles/25_cognitive_biases.md) и практические приёмы проверки фактов
- [Коллективный интеллект: как миллионы умов создают общее знание](4-internet_collective_intelligence.md) — как отличить правду от лжи в коллективном знании и [методы](../../../4.1_rules_of_study/how_to_learn_effectively/articles/note_taking.md) проверки информации
