...
[Перерыв](../../../7.2 Media, leisure and hobbies/Computer games/articles/useful_tips/eyes_and_back.md) важен: [мозг](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/breakfast_for_the_brain.md) должен «переваривать».
...
[Клип](1-Клиповое_мышление_когда_мир_выглядит_как_лента.md) — это затравка, а не вся [еда](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/stress_and_food.md).

---

## Три практики, которые реально работают

### 1) «Один [экран](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/gadgets_blue_light_sleep.md)»
...
Внимание растёт, когда [мозг](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/breakfast_for_the_brain.md) учится выдерживать скучное начало.  
...
Мозг любит [привычки](../../../1.2_natural_sciences/neurobiology_for_teens/articles/11_reward_system.md). Один и тот же маленький [ритуал](../../../2.1_society/how_and_where_find_friends/articles/druzhba_posle_shkoly.md) помогает включить [фокус](../../../1.2_natural_sciences/physics_in_everyday_life/Q35197.md):
...
- [заметки](../../../4.1_rules_of_study/how_to_memorize/articles/konspektirovanie.md) на бумаге (бумага не присылает [уведомления](../../../4.2_thinking_and_working_information/how_to_search_information/articles/information_hygiene.md)),
- [сон](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/evening_rituals_sleep_fast.md) и [отдых](../../../3.1. healthy lifestyle/Sleep, nutrition, and adolescent energy/articles/evening_rituals_sleep_fast.md) (без них внимание не чинится).
...
ВОЗ подчеркивает, что подросткам важно учиться принимать осознанные решения о своей онлайн-жизни и удерживать [баланс](../../../1.2_natural_sciences/physics_in_everyday_life/Q634.md) между цифровым и офлайн-миром. Значит, [цель](../../../1.2_natural_sciences/why_science_help_understand_world/research_work.md) не в [том](../../../7.1_art/musical_instruments/articles/drums.md), чтобы выбросить телефон, а в том, чтобы перестать быть его пленником. Настоящая цифровая грамотность начинается именно здесь: с [умения](../../../8.2_future/choosing_a_career_path/articles/skills.md) заметить, куда уходит твоё внимание, и вернуть его туда, где оно действительно нужно.

---

## Челлендж на неделю: «Внимание как [навык](../../information and media literacy/карта_компетенций_по_возрастам.md)»
...
Через неделю обычно заметно: входить в [фокус](../../../1.2_natural_sciences/physics_in_everyday_life/Q35197.md) стало легче. Не идеально, но заметно — как в спорте.
...
- [Клиповое мышление: когда мир выглядит как лента](1-Клиповое_мышление_когда_мир_выглядит_как_лента.md) — что такое клиповое [мышление](../../../1.2_natural_sciences/neurobiology_for_teens/articles/01_brain_complexity.md), его плюсы и минусы
